...
# tools/lib/just-lib.sh holds the prelude, the Pi's ssh and the kill patterns.
...
dashboard seconds="600" bag="" port="8080":
    @bash "{{ ws }}/tools/view/dashboard.sh" "{{ seconds }}" "{{ bag }}" "{{ port }}"
