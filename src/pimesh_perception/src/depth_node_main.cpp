// Standalone: `ros2 run pimesh_perception depth_node`.
//
...
//
//   ros2 run pimesh_perception depth_node --ros-args -p use_cuda:=false
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<pimesh_perception::DepthNode>(rclcpp::NodeOptions()));
  rclcpp::shutdown();
  return 0;
}
