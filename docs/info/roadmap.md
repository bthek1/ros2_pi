...
| M9 | `dashboard_node` — the web view | not started — [issue #8](https://github.com/bthek1/ros2_pi/issues/8) P8 |
...
`bash tools/test.sh` runs **341 hermetic tests across twenty-two suites** on both
