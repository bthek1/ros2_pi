...
| [#9 Camera calibration](https://github.com/bthek1/ros2_pi/issues/9) | Open — phase `P9` of the pipeline, **sequenced before P3**; promoted out of milestone A's future file 2026-09-10 | — |
