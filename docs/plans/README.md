...
| [#7 Milestone D](https://github.com/bthek1/ros2_pi/issues/7) | Open — **next up**, C having closed 2026-09-15 — phases `P5–P6` of the pipeline | [future/project_final_state.md](future/project_final_state.md) |
