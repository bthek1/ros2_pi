...
| [#6 Milestone C](https://github.com/bthek1/ros2_pi/issues/6) | Open — **next up**, B having closed 2026-09-13 — phase `P4` of the pipeline | [future/project_final_state.md](future/project_final_state.md) |
