...
| [#8 Milestone E](https://github.com/bthek1/ros2_pi/issues/8) | Open — **next up**, D having closed 2026-09-16 — phases `P7–P8` of the pipeline | [future/project_final_state.md](future/project_final_state.md) |
